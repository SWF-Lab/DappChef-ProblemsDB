...
contract answer84 {
   ...
   constructor() {
    ...
    function slash(address _staker) external onlyOwner {
        ...
        uint256 amountToSlash = stakedBalance[_staker] * slashPercentage / 100;
        require(amountToSlash > 0, "Amount to slash must be greater than 0");
        slashed[_staker] = true;
        totalStaked -= amountToSlash;
        stakedBalance[_staker] -= amountToSlash;
        totalRewards -= amountToSlash * rewardPerTokenStored / 1e18;
    ...
    function updateRewardPerToken() internal {
        ...
        uint256 rewardAccumulated = rewardPerSecond * timeDelta * 1e18;
